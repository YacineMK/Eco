...
const SideBar: FC = () => {
    ...
    return (
        <section className={`${isOpen ? "translate-x-0" : "-translate-x-full"} absolute md:translate-x-0  bg-[#fbfbfb] top-[80px] md:top-0 md:sticky bg-[#d9d9d91a] overflow-hidden bottom-0 md:h-screen w-[298px] border-r border-gray flex gap-6`}>
            <div className="my-10 w-full flex flex-col justify-between">
                <div className="w-full flex flex-col px-10 gap-9">
                    ...
                    {isMd ? <Card className="bg-[url('/profil.png')] bg-opacity-5 flex flex-col justify-center p-2 py-2 items-center  rounded-xl border h-48 border-green300">
